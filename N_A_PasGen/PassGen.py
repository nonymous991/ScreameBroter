...
class PassGen:
    ...
    def get_input(self):
        while self.is_alive:
            print(
                'Enter all information about the victim. ')
            print('And to generate, enter the gen. ')
    ...
    def append_data(self, data):
        ...
        elif len([_ for _ in data if _.isdigit()]) == (len(data) - 1):
            if not data in self.suffix:
                self.suffix.insert(0, data)
    ...
    def generate(self):
        print('Passwords are generated. Wait. ')
        time.sleep(5)
        ...
        with open('password_list.txt', 'wt', encoding='utf-8') as output_file:

            print(
                f'Was generated {len(self.password_list)} passwords.')
...
print("                                                      ")
print("######################################################")
print("Thank you! [PassGen v01 prod by N_A] или просто И***а]")
print("######################################################")
time.sleep(1)
print(" ")
